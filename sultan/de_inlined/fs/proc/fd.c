...
static int seq_show(struct seq_file *m, void *v)
{
	...
	/* v2.1.0 Standard: If process is umounted and accessing a SUS mount, spoof the ID */
...
#ifdef CONFIG_KSU_SUSFS_OPEN_REDIRECT
	/* v2.1.0 Standard: Fast bit-check before calling brain to spoof redirected FD info */
